...
// membuat scheduler yang mengembalikan promise
...
const p = scheduler(2);
async function test() {
    const resultA = await p.add(() => jobs("A", 1000));
    console.log("Hasil A: " + resultA);

    const resultB = await p.add(() => jobs("B", 500));
    console.log("Hasil B: " + resultB)
}
test();